            ...
            <CardContent class="grid gap-4">
                ...
                <div class="grid gap-6">
                    ...
                    <Button  variant="outline">
                      ...
                      <a href="http://localhost:64321/oauth2/authorization/google">Google</a>
                    </Button>
...
async function login() {
    ...
    try {
        const response = await axios.post(`${apiServerAddress}/api/user`, {
            email: email.value,
...
async function google() {
  console.log(email.value);
  try {
   // const googleR = await axios.get(`http://localhost:64321/oauth2/authorization/google`);
    // window.open(`http://localhost:64321/oauth2/authorization/google`);

    const  response = await axios.get(`${apiServerAddress}/api/user`);
    const token = response.data.token;
