package ch.nebulaWatches.api;

import ch.nebulaWatches.model.Item;
import ch.nebulaWatches.repository.ItemRepository;
...
public class Category {
    public final static Logger LOGGER = LoggerFactory.getLogger(Category.class);
